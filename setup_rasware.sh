...
echo -e "\n\nReady to go! To test to see if your setup is correct, cd into the RASDemo folder ('cd ~/RASBox/Rasware/RASDemo'), plug in your TM4C through the USB, flip the switch to debug mode, and call 'make flash'!"
